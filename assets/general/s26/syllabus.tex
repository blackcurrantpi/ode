...
\rhead{Spring 2026 (Bobrovnikov)%; \textsl{updated}
}
...
\emph{Course Information} & \hspace{-3mm} \begin{tabular}[t]{l}
                  ...
                  CRN:\, 31040 (section 901) \\
                  time:\, 9:15--10:15am \\
                  room:\, Chapman 104 (\emph{in person}) \\
                  \end{tabular} \\
 & \\
...
\emph{Websites} & \hspace{-3mm} \begin{tabular}[t]{ll}
                  ...
                  \href{https://canvas.alaska.edu/courses/30047}{\tt canvas.alaska.edu/courses/30047} \, (Canvas) & grades and solutions
                  \end{tabular} \\
 & \\
...
\smallskip
\centerline{\href{https://blackcurrantpi.github.io/ode/assets/general/s26/schedule.pdf}{\tt blackcurrantpi.github.io/ode/assets/general/s26/schedule.pdf}}
...
Student performance is primarily assessed by six in-class Quizzes and two in-class Exams.  Homework assignments are due more frequently.  See the \href{https://blackcurrantpi.github.io/ode/assets/general/s26/schedule.pdf}{Schedule}.
 

\subheading{Quizzes}% (\underline{\textsl{updated}})}
Every other week there will be a 25 minute Quiz, at the start of class on Wednesday (except week 15, that week it will happen on Friday).  It will cover the material taught in the previous two weeks.  Quizzes are equally weighted, and are given under Exam testing conditions, and they are practice for the Exams.  (Quiz performance is the best predictor of Exam performance.)  Books, notes, and calculators are \emph{not} allowed.  The lowest Quiz grade will be dropped.  Solutions to Quizzes will be handed out on paper immediately, and posted on the \href{https://canvas.alaska.edu/courses/30047}{Canvas site}.  Immediately after the Quiz will be a 15 minute de-brief, where we all talk through the solutions.  Then the lecture for that day will resume.


\subheading{Exams}
There is a Midterm Exam on Friday 6 March and a Final Exam 8:00--10:00am on Friday 1 May.   Books, notes, and calculators are \emph{not} allowed.  Solutions will be posted on the \href{https://canvas.alaska.edu/courses/30047}{Canvas site}.


\subheading{Homework}
% Each textbook section will correspond to a Homework assignment, due through Gradescope at 11:59pm on the date indicated on the \href{https://bueler.github.io/math302/assets/general/F23/schedule.pdf}{Schedule}.  (The Gradescope page is accessed through the \href{https://canvas.alaska.edu/courses/30047}{Canvas site}.)  Homework assignments are designed to help you learn!  I will grade a few selected-in-advance problems for correctness, with the remaining problems graded for completion only.  See the \href{https://bueler.github.io/math302/homework.html}{Homework tab} for the problems.
...
WRH will be posted on the public webpage:
{\href{https://blackcurrantpi.github.io/ode/homework.html}{\tt blackcurrantpi.github.io/ode/homework.html}}.
WA will be posted on the \href{https://canvas.alaska.edu/courses/30047}{Canvas site}.
WRH will typically be
due Monday by 11:59 pm as a single pdf file via Gradescope. (The Gradescope page is accessed through the \href{https://canvas.alaska.edu/courses/30047}{Canvas site}.) Keep in mind
\begin{enumerate}%[1.]
