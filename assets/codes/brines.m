% BRINES  Illustrate solutions x_1(t), x_2(t), x_3(t) for the following
% problem: there are three connected 100 gallon tanks, A, B, and C, 
% containing brine solutions; the flows are the following:
% pure water -> A at 2 gal/min,
% A -> B at 4 gal/min,
% B -> A at 2 gal/min,
% B -> C at 5 gal/min,
% C -> B at 3 gal/min,
% C -> dumped at 2 gal/min.
% The x_i(t) are the pounds of salt.  Initial conditions
